...
public class ExamplesData {
    ...
    private static TableItem getGridsData() {
        ...
        items.add(new NavigationItem(GroupingGridDemo.TITLE));
        items.add(new NavigationItem(PagingGridDemo.TITLE));
        items.add(new NavigationItem(GridFilterDemo.TITLE));
        // items.add(new NavigationItem("Grid Plugins"));
        items.add(new NavigationItem(GridCellEditingDemo.TITLE));
        // items.add(new NavigationItem("Multiple Sorting"));
        items.add(new NavigationItem(GridDataBindingDemo.TITLE));
        items.add(new NavigationItem(LockedGridDemo.TITLE));
        items.add(new NavigationItem(GridRowEditingDemo.TITLE));
        // items.add(new NavigationItem("Multiple Sorting"));
