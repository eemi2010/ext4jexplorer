...
public class SimpleGridDemo extends DemoBase {

    public static final String TITLE = "Simple Grid";

    public static SimpleGridDemo get() {
        return new SimpleGridDemo();
    }

    private SimpleGridDemo() {
    ...
    private static class Company extends BaseModel {
        ...
        public static List<Company> getList() {
            List<Company> list = new ArrayList<SimpleGridDemo.Company>();
