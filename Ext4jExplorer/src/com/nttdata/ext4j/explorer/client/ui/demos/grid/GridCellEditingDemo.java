...
import com.nttdata.ext4j.client.grid.plugin.CellEditing;
...
public class GridCellEditingDemo extends DemoBase {

    public static final String TITLE = "Grid Cell Editing";

    public static GridCellEditingDemo get() {
        return new GridCellEditingDemo();
    }

    private Store store;
    private CellEditing cellEditing = new CellEditing(1);

    private GridCellEditingDemo() {
