...
public class LockedGridDemo extends DemoBase {

    public static final String TITLE = "Locking Grid";

    public static LockedGridDemo get() {
        return new LockedGridDemo();
    }

    private LockedGridDemo() {
    ...
    private static class Company extends BaseModel {
        ...
        public static List<Company> getList() {
            List<Company> list = new ArrayList<LockedGridDemo.Company>();
