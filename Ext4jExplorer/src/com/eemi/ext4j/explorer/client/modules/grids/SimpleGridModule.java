...
public class SimpleGridModule extends BaseDemoModule {

    private final String TITLE = "Simple Grid";
    public static final SimpleGridModule INSTANCE = new SimpleGridModule();
    ...
    public DesktopModuleConfig createModuleConfig() {
        ...
        moduleConfig.setModuleDescription("Ext4j Simple Grid demo");
        moduleConfig.setWallPaperIcon(GridsModuleResource.ICONS.simpleGrid128());
        moduleConfig.setToolbarIcon(GridsModuleResource.ICONS.simpleGrid24());
        moduleConfig.setMenuItemIcon(GridsModuleResource.ICONS.simpleGrid16());
    ...
    private static class Company extends BaseModel {
        ...
        public static List<Company> getList() {
            List<Company> list = new ArrayList<SimpleGridModule.Company>();
