...
public class LockedGridModule extends BaseDemoModule {

    private final String TITLE = "Locking Grid";
    public static final LockedGridModule INSTANCE = new LockedGridModule();
    ...
    public DesktopModuleConfig createModuleConfig() {
        ...
        moduleConfig.setModuleDescription("Ext4j Locked Grid demo");
        moduleConfig.setWallPaperIcon(GridsModuleResource.ICONS.lockedGrid128());
        moduleConfig.setToolbarIcon(GridsModuleResource.ICONS.lockedGrid24());
        moduleConfig.setMenuItemIcon(GridsModuleResource.ICONS.lockedGrid16());
    ...
    private static class Company extends BaseModel {
        ...
        public static List<Company> getList() {
            List<Company> list = new ArrayList<LockedGridModule.Company>();
